        ...
        <footer className="mt-[900px] md:mt-0 bg-blue-500 py-8 w-full">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-white mb-4">Nossos produtos</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-white mb-4">Dicas e Avisos</h2>
                        <ul className="text-gray-200">
                            <li>Adoção</li>
                            <li>Cuidados</li>
                            <li>Alimentação</li>
                ...
                <div className="mt-8 text-center flex flex-wrap">
                    <p className="text-gray-200">© {new Date().getFullYear()} Seu Site. Todos os direitos reservados.</p>
                </div>
            </div>
        </footer>
    )

    ...
    return (
        <div className="flex flex-col h-screen justify-center items-center">
            <div className={`${blogContainerClass} bg-blue-200 p-8 rounded-lg mb-4`}>
                ...
                <p>
                    Medidas Urgentes para Combater o Aumento Alarmante de Animais Abandonados no Brasil
                </p>
                <button
                    className="text-blue-500 mt-2"
                    onClick={() =>
                        openModal('Nos últimos anos, o Brasil tem enfrentado um desafio crescente que causa preocupação e tristeza em muitas pessoas: o aumento alarmante de animais abandonados. Essa realidade tem se tornado cada vez mais evidente nas ruas das cidades, nos abrigos e nas redes sociais, onde imagens de animais desamparados e em situações precárias se espalham com frequência. As razões por trás desse fenômeno são diversas e complexas. Entre elas, podemos citar o abandono motivado pela falta de responsabilidade dos tutores, que muitas vezes não consideram a adoção de um animal como um compromisso de longo prazo. Além disso, a falta de informação sobre a importância da castração e dos cuidados básicos com os pets contribui para a reprodução descontrolada e, consequentemente, para o aumento do número de animais abandonados.','https://exame.com/bussola/abandono-de-animais-aumentou-cerca-de-60-durante-a-pandemia/')
                    }
                >
                    &rarr;
                </button>
            ...
            <div className={`${blogContainerClass} bg-green-200 p-8 rounded-lg mb-4`}>
                <h1 className="text-2xl font-bold mb-2">Combate ao abandono de animais</h1>
                <p>
                ...
                <button
                    className="text-blue-500 mt-2"
                    onClick={() =>
                        openModal('O abandono de animais é um problema grave e preocupante que afeta milhares de seres indefesos em todo o mundo. No entanto, esse fenômeno não é inevitável e precisa ser combatido de forma enérgica e consciente pela sociedade como um todo. Uma das principais medidas para combater o abandono de animais é a conscientização. É fundamental educar a população sobre a importância da posse responsável e dos cuidados necessários para garantir o bem-estar dos animais de estimação. Informar sobre a esterilização, a vacinação, a alimentação adequada, os passeios regulares e a atenção veterinária são aspectos essenciais que devem ser abordados.','https://www.cvsf.com.br/dezembro-verde-mes-de-conscientizacao-e-combate-ao-abandono-de-animais/')
                    }
                >
                    &rarr;
                </button>
